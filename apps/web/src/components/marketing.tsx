    ...
    <div className="landing-shell min-h-dvh bg-background text-foreground">
      ...
      <main id="marketing-main">
        ...
        <section id="paths" className="landing-paths-skin mx-auto max-w-7xl scroll-mt-8 px-5 py-20 sm:px-8 lg:py-28">
          ...
          <div className="grid gap-10 border-t border-foreground/15 lg:grid-cols-2 lg:gap-0">
            {paths.map((path, index) => (
              <article key={path.label} className={index === 0 ? "pt-9 lg:pe-14" : "border-t border-foreground/15 pt-9 lg:border-s lg:border-t-0 lg:ps-14"}>
                <p className="text-sm font-medium text-primary">{path.label}</p>
        ...
        <section id="evidence" className="landing-evidence-skin mx-auto grid max-w-7xl scroll-mt-8 gap-12 px-5 py-20 sm:px-8 lg:grid-cols-2 lg:items-center lg:gap-24 lg:py-28">
          ...
          <div className="landing-evidence-trail border-y border-foreground/20">
            {[
        ...
        <section className="landing-closing-skin border-t border-foreground/10 bg-card/60 px-5 py-16 sm:px-8 lg:py-20"><div className="mx-auto flex max-w-7xl flex-col justify-between gap-8 lg:flex-row lg:items-center"><div><p className="text-sm text-muted-foreground">Your next conversation starts here.</p><h2 className="mt-3 text-4xl font-semibold tracking-[-0.045em] sm:text-5xl">Take your seat.</h2></div><div className="flex flex-col gap-3 sm:flex-row"><Button size="lg" asChild className="landing-primary-cta"><Link href={candidateSignup}>Start practicing<ArrowRight aria-hidden="true" /></Link></Button><Button size="lg" variant="outline" asChild><Link href={recruiterSignup}>Create an interview<ArrowRight aria-hidden="true" /></Link></Button></div></div></section>
      </main>
